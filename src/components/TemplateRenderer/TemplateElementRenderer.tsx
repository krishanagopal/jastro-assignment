...
export const TemplateElementRenderer: React.FC<TemplateElementRendererProps> = ({
  ...
  const nodeStyle: React.CSSProperties = {
    ...
    borderColor: props?.style?.borderColor || undefined,
    fontFamily: props?.style?.fontFamily || undefined,
    fontSize: props?.style?.fontSize || undefined,
    fontWeight: (props?.style?.fontWeight as any) || undefined,
    fontStyle: (props?.style?.fontStyle as any) || undefined,
    textDecoration: (props?.style?.textDecoration as any) || undefined,
    lineHeight: props?.style?.lineHeight || undefined,
    letterSpacing: props?.style?.letterSpacing || undefined,
    textAlign: (props?.style?.textAlign as any) || undefined,
    textTransform: (props?.style?.textTransform as any) || undefined,
